...
char All_players_name[8][10][20] = {{"Rohit Sharma", "Virat Kohli", "MS Dhoni", "Suresh Raina", "Yuvraj Singh", "Ravindra Jadeja", "Hardik Pandya", "R Ashwin", "Jasprit Bumrah", "Mohd Shami"}, {"Misbah-ul-Haq", "Younis Khan", "Shahid Afridi", "Ahmed Shehzad", "Haris Sohail", "Sarfaraz Ahmed", "Umar Akmal", "Mohammad Irfan", "Wahab Riaz", "Mohammad Amir"}, {"Steve Smith", "David Warner", "Glenn Maxwell", "George Bailey", "Shane Watson", "Usman Khwaja", "Brad Haddin", "Pat Cummins", "Mitchell Starc", "James Faulkner"}, {"Joe Root", "Eoin Morgan", "Jos Butler", "Alex Hales", "Ian Bell", "Moeen Ali", "Chris Woakes", "Adil Rashid", "Stuart Broad", "James Anderson"}, {"Brendon McCullum", "Kane Williamson", "Martin Guptill", "Grant Elliot", "Corey Anderson", "Tim Southee", "Adam Milne", "Daniel Vettori", "Trent Boult", "M McClenaghan"}, {"Chris Gayle", "Andre Russell", "Keiron Pollard", "Darren Bravo", "Marlon Samuels", "Dinesh Ramdin", "Darren Sammy", "Jason Holder", "Kemar Roach", "Sunil Narine"}, {"T. Dilshan", "Kumar Sangakara", "Upul Theranga", "M. Jayawardene", "L. Thirimanne", "Angelo Mathews", "D. Chandimal", "Rangana Herath", "Thisara Perera", "Lasith Malinga"}, {"Q. de Kock", "Hashim Amla", "AB de Villiers", "David Miller", "JP Duminy", "Kyle Abbott", "Kagiso Rabada", "Imran Tahir", "Morne Morkel", "Dale Steyn"}};
